...
<div class="container my-5" style="max-width:400px;">
    ...
    <form action="login" method="post">
        <div class="mb-3">
            ...
            <select class="form-select" id="emailDropdown" name="email" required>
...
<!--            <input type="email" class="form-control" id="loginEmail" name="email" value="${email}"-->
<!--                   onblur="checkmail(); loginemail();" required>-->
<!--        </div>-->
        <div class="mb-3">
            <label for="loginPassword" class="form-label">Password</label>
            <input type="password" class="form-control" id="loginPassword" name="password" value="${dto.password}"
