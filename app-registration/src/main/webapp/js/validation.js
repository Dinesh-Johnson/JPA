...
function checkaddress() {
    // ✅ Make sure textarea has id="exampleFormControlTextarea1"
...
// ✅ Run countdown only if timer element exists
...
pincodeDropdown.addEventListener("change", function () {
  ...
  fetch(url, {
    ...
    .then((data) => {
      ...
      // 👉 Here you can display city/state info in form fields if needed
    })
    .catch((err) => {
